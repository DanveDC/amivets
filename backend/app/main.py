...
from app.routers import mascotas, facturas, propietarios, consultas, citas, pruebas, inventario, reportes, auth, usuarios, hospitalizaciones, cirugias, clinico, supabase_admin, catalogo, liquidaciones, notas, servicios, ordenes, areas, notificaciones, adjuntos, caja_rapida, comisiones
import time
import logging
import subprocess
